...
.login {
    height: 1000px;
    width: 100%;
    background: radial-gradient(#6590d1, #332042);
    position: relative;
}
.login_box {
    width: 1050px;
...
<body>
    ...
    <div class="form-group">
        <input type="password" name="password_confirmation" class="form-control" id="confirm_password" placeholder="KONFIRMASI">
    </div>
    ...
    <button type="submit" class="btn btn-primary">Register</button>
			...
			<div class="right">
				<div class="right-text">
					<h2>KOSTKITA</h2>
					<h5>BERSAMA KITA SEMUA BISA,ASIK ICIKIWIR</h5>
				</div>
